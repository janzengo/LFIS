...
<div class="row">
    ...
    <div class="card">
            <div class="card-body py-4 pre-compressed">
                <h4 class="pageTitle pagePreTitle">Send us a Message</h4>
                <form action="" id="inquiry-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="contact" placeholder="Enter your Contact no."  name="contact" required="required">
                    </div>
                    <div class="mb-3">
            ...
            <div class="card-footer">
                <div class="col-lg-4 col-md-6 col-sm-10 col-12 mx-auto">
                    <button class="btn btn-outline-success btn-sm w-100" form="inquiry-form"><i class="bi bi-send"></i> Send Message</button>
                </div>
            </div>
        </div>
    </div>
